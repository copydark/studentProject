...
import jnflsicSurveyListDataProcess.surveyReportDataProcess;
import jnflsicSurveyListDataProcess.surveyReportListTable;
import jnflsicSurveyListDataProcess.surveyTeacherReport;
 ...
 * @author shen
 */
public class ManageSurveryReport extends javax.swing.JFrame {

    /**
     * Creates new form ManageClassForm
     */
    public ManageSurveryReport() {
        initComponents();
        setDepartmentList();
    ...
    private void initComponents() {
        ...
        jComboBoxDepartment.setFocusable(false);
        ...
        jComboBoxArea.setFocusable(false);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "TeacherID", "Teacher Name", "Course Name", "Grade", "NumOfStudent", "Question1", "Question2", "Question3", "Question4", "Question5", "Question6", "Question7", "Question8", "Question9", "Question10", "Question11", "Question12", "Question13", "Question14", "Question15"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Integer.class, java.lang.String.class, java.lang.String.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class
            };
        ...
        jLabelTablePage.setEnabled(false);

        jLabel6.setText("Page");
        jLabel6.setEnabled(false);

        jLabelTotalP.setText("/1");
        jLabelTotalP.setEnabled(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int QuestionsCount = surveyReportDataProcess.getNumOfQuestion();
        String colTitle[] = new String[5+QuestionsCount];
        //Select teacherID, teacherName, courseName, grade, sum(`count`)
        colTitle[0] = "TeacherID";
        colTitle[1] = "Teacher Name";
        colTitle[2] = "Course Name";
        colTitle[3] = "Grade";
        colTitle[4] = "NumOfStudent";
        int j = 1;
        for(int i = 5; i<colTitle.length; i++){
            colTitle[i] = "Question"+j;
        ...
        dtm2.setDataVector(null, colTitle);
...
//            }
//        }
        surveyReportDataOrg s[] = new surveyReportDataOrg [row];
        for(int i = 0; i<row; i++){
            s[i] = new surveyReportDataOrg();
            s[i].setTeacherID(Integer.parseInt(dtm2.getValueAt(i, 0).toString()));
            s[i].setTeaccherName(dtm2.getValueAt(i, 1).toString());
            s[i].setCourseName(dtm2.getValueAt(i, 2).toString());
            s[i].setGrade(Integer.parseInt(dtm2.getValueAt(i, 3).toString()));
            s[i].setNumOfStudent(Integer.parseInt(dtm2.getValueAt(i, 4).toString()));
            int score[] = new int[15];
            
            for(int j = 0; j<15; j++){
                score[j] = Integer.parseInt(dtm2.getValueAt(i, j+5).toString());
            }
            s[i].setQuestionscore(score);
        }
        try {
            surveyTeacherReport.generateWord(s);
            JOptionPane.showMessageDialog(null, "Generate a group of Report");
        } catch (TemplateException ex) {
            Logger.getLogger(ManageSurveryReport.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageSurveryReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManageSurveryReport().setVisible(true);
            }
        });
    }
